...
class DataTransformation:
    ...
    def get_data_transformation_object(self)->Pipeline:
        logging.info("entering get data tranforamtino object")
        try:
    ...
    def initiate_data_transformation(self):
        logging.info("Entered Initiate data tranformation")
        try:
            ...
            save_object("final_model/peprocessor.pkl",preprocessor)
