...
class ModelTrainer:
    ...
    #         with mlflow.start_run():
    #             logging.info(f"Logging metrics for model: {type(best_model).__name__}")
    ...
    #             logging.info("Attempting to log model...")
    #             mlflow.sklearn.log_model(best_model, "model")
    #             logging.info("Model logged successfully to artifacts/model/")
    #     except Exception as e:
    ...
    def track_mlflow(self, best_model, classification_train_metric, classification_test_metric, experiment_name="network"):
        """
        Logs metrics and best model to MLflow under one run.
        """

        mlflow.set_experiment(experiment_name)

        # Start one run only
        with mlflow.start_run(run_name="network_trainer"):
